...
BOOL CCarEditorApp::InitInstance()
{
...
void CCarEditorApp::OnEditLocation() 
{
	char fileName[256];
...
void CCarEditorApp::OnGp2exe() 
{
	OnGp2Exe();
}


CString CCarEditorApp::getGP2Location()
{
	 CString strSection       = "Preferences";
     CString strStringItem    = "GP2Location";
	 CWinApp* pApp = AfxGetApp();
...
void CCarEditorApp::OnEditgp2location() 
{
	OnEditLocation();
}
...
void CCarEditorApp::OnFileimport() 
{
...
void CCarEditorApp::OnEditDistanceTrigger() 
{
	char buffer[1024];
...
void CCarEditorApp::OnJamView(CDocument *pDoc)
{
...
void CCarEditorApp::OnSetAnimationDelay() 
{
...
void CCarEditorApp::OnInternalJam() 
{
	useExternalJams = !useExternalJams;
}

void CCarEditorApp::OnUpdateInternalJam(CCmdUI* pCmdUI) 
{
