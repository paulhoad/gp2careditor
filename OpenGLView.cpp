...
void COpenGLView::RenderScene(CPaintDC *dc)
{
	// prepare a semaphore
...
void COpenGLView::setupDIB(HDC hDC)
{
    BITMAPINFO *bmInfo;
...
void COpenGLView::setupPalette(HDC hDC)
{
...
void COpenGLView::resizeDIB(HDC hDC)
{
...
void COpenGLView::SwapAnyBuffers(HDC hdc)
{
  if (renderToDIB) {
			 ...
			 //StretchBlt(hdc, nWidth, 0, nWidth,nHeight, memdc, 0, 0, bmp.bmWidth,bmp.bmHeight,SRCCOPY);
